...
![Tiled 3×3 matmul: Each thread loads one A and one B element per tile, computes a partial sum, then syncs. Tile size = 3, 9 threads per block.](mojo_gpu_puzzles/p14_tiled_matmul_annotated.png){fig-align='center'}
